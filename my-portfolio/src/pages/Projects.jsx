...
//         }
//       >
//         <div className="container mx-auto py-20 px-2 max-w-7xl">
...
//           <div className="grid md:grid-cols-3 gap-6 px-1">
...
//                           : "bg-white text-gray-800 border-blue-500 hover:bg-blue-500 hover:text-white hover:border-blue-500"
//                       }`}
//                     >
